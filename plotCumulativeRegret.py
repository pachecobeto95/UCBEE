...
def main(args):
  ...
  ucb_filename = os.path.join(config.DIR_NAME, "new_ucb_results_final_less_arms", "caltech256", "mobilenet", "new_ucb_results_no_calib_mobilenet_1_branches_id_%s_less_arms.csv"%(args.model_id))
